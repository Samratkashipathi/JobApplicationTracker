...
from ..utils.validation import validate_season_name, validate_company_name, validate_role
...
class JobTrackerService:
    ...
    # Season Management
    def create_season(self, name: str) -> tuple[bool, str, Optional[int]]:
        """
        Create a new season
        ...
        try:
            ...
            season_id = self.season_repo.create(season)
    ...
    def get_active_season(self) -> Optional[Season]:
        ...
        return self.season_repo.get_active()
    
    def get_all_seasons(self) -> List[Season]:
        """Get all seasons"""
        return self.season_repo.get_all()
    ...
    def add_job(
        ...
        try:
            ...
            return True, f"Job application for {role} at {company_name} added successfully!", job_id
        except Exception as e:
    ...
    def get_jobs_by_season(self, season_id: int = None) -> List[Job]:
        ...
        return self.job_repo.get_by_season(season_id)
    ...
    def delete_job(self, job_id: int) -> tuple[bool, str]:
        ...
        try:
            ...
            if self.job_repo.delete(job_id):
                return True, f"Job application for {job.role} at {job.company_name} deleted successfully"
            else:
    ...
    def update_job(self, job: Job) -> tuple[bool, str]:
        ...
        try:
            ...
            if self.job_repo.update(job):
                return True, f"Job application for {job.role} at {job.company_name} updated successfully"
            else:
